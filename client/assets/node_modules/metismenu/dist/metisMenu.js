...
(function (global, factory) {
  ...
  function () {
    ...
    _proto.init = function init() {
      ...
      //custom for menu with no sub-menu
      $(this.element).find(conf.parentTrigger).not(':has(ul)').children(conf.triggerElement).on(Event.CLICK_DATA_API, function(e) {
        var eTar = $(this);
        var paRent = eTar.parent(conf.parentTrigger);
        var sibLings = paRent.siblings(conf.parentTrigger).not(':has(ul)').children(conf.triggerElement);
        var List = paRent.siblings().children(conf.subMenu);
        ...
        var brother =paRent.siblings(conf.parentTrigger);
        ...
        if (paRent.hasClass(ClassName.ACTIVE)) {
          ...
          brother.removeClass(ClassName.ACTIVE);
          self.show(List);
          eTar.attr('aria-expanded', 'true');
